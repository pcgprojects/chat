			...
			<div class="row justify-content-center h-100">
				...
				<div class="col-md-12 col-xl-6 chat">
					<div class="card">
						...
						<div class="card-body msg_card_body" id="body_messages">
						...
						<div class="card-footer">
							<div class="input-group">
								...
								<textarea name="" id="txtmessage" class="form-control type_msg" placeholder="Type your message..."></textarea>
								<div class="input-group-append">
